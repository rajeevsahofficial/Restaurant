 ...
 * Contains the dark/light mode toggle (and space for future breadcrumbs /
 * notifications).  Kept as a separate client component so the layout itself
...
export default function AdminTopbar() {
  ...
  return (
    ...
    >
      {/* Left — breadcrumb slot (empty for now; pages manage their own <h1>) */}
      <div />

...
function LoadingState() {
  return (
    <div className="flex min-h-[60vh] items-center justify-center gap-3">
      <svg className="h-5 w-5 animate-spin" viewBox="0 0 24 24" fill="none" style={{ color: "var(--admin-accent)" }}>
    ...
    <div className="px-4 pt-24 pb-6 sm:pt-6 sm:px-6 lg:px-8">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div className="min-w-0 flex-1">
          <h1 className="truncate text-2xl font-bold" style={{ color: "var(--admin-text-primary)" }}>
            Edit: {item.name}
          </h1>

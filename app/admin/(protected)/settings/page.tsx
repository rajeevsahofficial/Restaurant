      ...
      <form id="settings-form" onSubmit={handleSave} noValidate>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <SectionCard id="brand" title="Brand" description="Name and tagline shown to customers on the live menu">
            <div className="grid gap-5 sm:grid-cols-2">
              <Field label="Restaurant Name" error={errors.name} required>
                <input type="text" value={settings.name} onChange={(e) => set("name", e.target.value)} placeholder="Enter restaurant Name" className={inputCls(!!errors.name)} />
              </Field>
            ...
            <Field label="Tagline" hint="Appears on the hero banner of the customer menu">
              <input type="text" value={settings.tagline} onChange={(e) => set("tagline", e.target.value)} placeholder="Enter restaurant tagline" className={inputCls(false)} />
            </Field>
          </SectionCard>
          ...
          <SectionCard id="contact" title="Contact Details" description="Shown in the menu footer and customer receipts">
            <Field label="Address">
              <textarea rows={2} value={settings.address} onChange={(e) => set("address", e.target.value)} placeholder="Enter your restaurant address" className={cn(inputCls(false), "resize-none")} />
            </Field>
            <div className="grid gap-5 sm:grid-cols-2">
              <Field label="Phone Number">
                <div className="input-group">
                  ...
                  <input type="tel" value={settings.phone} onChange={(e) => set("phone", e.target.value)} placeholder="Enter your mobile number" />
                </div>
              </Field>
              <Field label="Email Address" error={errors.email}>
                <div className={cn("input-group", errors.email && "has-error")}>
                  ...
                  <input type="email" value={settings.email} onChange={(e) => set("email", e.target.value)} placeholder="Enter your email" />
                </div>
              </Field>
            </div>
          </SectionCard>
            ...
            <div className="grid gap-5">
              ...
              <Field label="Tax / GST Rate" error={errors.tax_rate} required>
                <div className="relative">
                  ...
                  />
                  <span className="pointer-events-none absolute left-[35px] top-1/2 -translate-y-1/2 text-sm font-semibold" style={{ color: "var(--admin-text-muted)" }}>%</span>
                </div>
              </Field>
            </div>
          </SectionCard>

...
interface StatCardProps {
  ...
  iconBg: string;   // css color string
  href?: string;
}
  ...
  const inner = (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        ...
        {sub && (
          <p className="mt-0.5 text-xs" style={{ color: "var(--admin-text-muted)" }}>{sub}</p>
        )}
      </div>
      {href && (
        <svg
    ...
    <div className="px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-2">
        ...
        >
          ...
          >
            <div>
              <h2 className="text-sm font-bold" style={{ color: "var(--admin-text-primary)" }}>
                Popular Dishes
              </h2>
              <p className="mt-0.5 text-xs" style={{ color: "var(--admin-text-muted)" }}>
                Top rated items on your menu
              </p>
            </div>
            <Link
              href="/admin/menu"
          ...
          <div>
            {topItems.map((item, idx) => (
              <div
                ...
                style={{
                  borderBottom: idx < topItems.length - 1
        ...
        <div className="space-y-5">
          ...
          >
            <h2 className="mb-1 text-sm font-bold" style={{ color: "var(--admin-text-primary)" }}>
              Quick Actions
            </h2>
            ...
            <div>
              {recentItems.map((item, idx) => (
                <div
                  ...
                  style={{
                    borderBottom: idx < recentItems.length - 1
                      ? "1px solid var(--admin-border)"
                      : "none",
                  }}
                >
